        ...
        <div class="container mt-5">
            ...
            <div class="row mt-4">
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Jamon</h5>
                            <p class="card-text">Descripción: Carne de la mejor calidad :) </p>
                            <p class="card-text">Marca: Toledo</p>
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text">Descripción: La mejor agua del mundo :)</p>
                            <p class="card-text">Marca: Coca-cola </p>
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text">Descripción: El mejor del mundo :)</p>
                            <p class="card-text">Marca: Bimbo </p>
                            <p class="card-text">Precio: Q.15.00</p>
                        </div>
                    </div>
                </div>
            </div>
